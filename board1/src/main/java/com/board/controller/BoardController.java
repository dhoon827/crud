...
//게시물 작성
	...
	public String getView(@RequestParam("bnumber") int bnumber, Model model, HttpSession session) throws Exception {
	  ...
	  @RequestMapping(value="/openpassword", method=RequestMethod.POST)
	  public String openPass(@RequestParam("bnumber") int bnumber, @RequestParam("bdnumber") int bdnumber, Model model, HttpServletRequest request) throws Exception {
		  model.addAttribute("bnumber",bnumber);
	  model.addAttribute("bdnumber",bdnumber);
	  System.out.println("model : "+model);
	  System.out.println("bnumber : "+bnumber);
	  System.out.println("bdnumberaaa : "+bdnumber); 
	  return "board/openpassword";
	  }
